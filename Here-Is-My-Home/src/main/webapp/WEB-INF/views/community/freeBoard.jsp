...
<body>
	...
	<div class="container">
              ...
              <table class="table table-hover" style="text-align: center;">
                ...
                <tbody>
                    <tr class="table-light">
                      <th scope="row"><a href="/Front/FreeView.html" style="text-decoration: none;">TEST게시판글</a></th>
                      <td>쏭쓰</td>
        ...
        <span class="float-end"><a href="/Front/FreeWrite.html" style="text-decoration: none;"><button type="button" class="btn btn-info">글쓰기</button></a></span>
        <div><br><br></div>
    </div>
